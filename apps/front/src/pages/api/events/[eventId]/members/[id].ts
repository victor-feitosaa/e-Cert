// src/pages/api/events/[eventId]/members/[id].ts
...
export const DELETE: APIRoute = async ({ params, request }) => {
  ...
  console.log("🔴 DELETE Member - Event ID:", eventId);
  console.log("🔴 DELETE Member - Member ID:", id);

  // URL do backend
  const baseUrl = import.meta.env.API_URL || "https://ecert.duckdns.org";
  

  const url = `${baseUrl}/events/${eventId}/member/${id}`;
