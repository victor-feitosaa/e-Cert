...
export const GET: APIRoute = async ({ params, request }) => {
  ...
  const url = `${baseUrl}/events/${eventId}/export/certificates`;
  ...
  try {
    ...
    return new Response(blob, {
      ...
      headers: {
        ...
        'Content-Disposition': response.headers.get('Content-Disposition') || `attachment; filename=certificados-${eventId}.xlsx`,
      }
    });
  } catch {
